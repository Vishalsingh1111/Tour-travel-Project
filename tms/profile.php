    ...
    <section id="packages" class="secPad" style="margin:20vmin auto">
      <div class="container">
        <div class="heading text-center">
          <!-- Heading -->
          <h2>Your Profile</h2>
          <p>You Can Edit or Update your Details Here.</p>
        </div>
        <div class="privacy">
          <div class="container">
            <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Your Profile Details</h3>
            ...
            <form name="chngpwd" method="post">
              ...
              <p style="width: 350px; margin-top:3vmin;">
