...
<section id="packages" class="secPad">
  <div class="container">
    <div class="heading text-center">
      <!-- Heading -->
      <h2>Tour History</h2>
      <p>History of your tour Booking and Cancellation.</p>
    </div>
    <div class="privacy">
      <div class="container">
        ...
        <form name="chngpwd" method="post" onSubmit="return valid();">
          ...
          <p>
            <table class="table align-items-center table-flush table-hover table-bordered"  style="margin:5vmin auto 30vmin auto;width=100%">
              <tr align="center">
                <th>S.No.</th>
                <th>Booking Id</th>
                <th>Package Name</th> 
