                  ...
                  <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label class="col-sm-12 pl-0 pr-0">Package Title</label>
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="text" class="form-control" name="packagename" id="packagename" placeholder="Enter Package Title" required>
                        </div>
                      </div>
                      <div class="form-group col-md-6 pl-md-0">
                        <label class="col-sm-12 pl-0 pr-0">Durations</label>
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="text" class="form-control" name="packagetype" id="packagetype" placeholder=" Enter Durations eg- Day / Night" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="form-group col-md-6 pl-md-0">
                      ...
                      <div class="col-sm-12 pl-0 pr-0">
                        <input type="text" class="form-control" name="packageprice" id="packageprice" placeholder=" Enter Price" required>
                      </div>
                    </div>
                  </div>
